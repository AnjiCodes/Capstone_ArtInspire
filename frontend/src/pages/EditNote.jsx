        ...
        <div className="px-6 md:px-[200px] mt-8">
            ...
            <form className="w-full flex-flex-col space-y-4 md:space-y-8">
                ...
                <div className='flex flex-col space-y-4 '>
                    ...
                    <button className="bg-pink w-full md:w-[20%] mx-auto text-white gont-semibold px-4 py-2 text-lg">Update</button>
                    <button className="bg-pink w-full md:w-[20%] mx-auto text-white gont-semibold px-4 py-2 text-lg"><Link to="/NoteDetails">Go Back</Link></button>
                </div>
            </form>
        </div>
      )
